...
public class RubyRightPadded {
    ...
    public enum Location {
        ...
        CLASS_METHOD_DECLARATION_PARAMETERS_SUFFIX(RubySpace.Location.CLASS_METHOD_DECLARATION_PARAMETERS_SUFFIX),
        ...
        RATIONAL_NUMERATOR_SUFFIX(RubySpace.Location.RATIONAL_NUMERATOR_SUFFIX),
